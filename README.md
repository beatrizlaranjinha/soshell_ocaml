...
O projeto inclui execução de comandos externos, comandos embutidos, redirecionamentos, pipes simples e múltiplos, execução em foreground e background, operações com ficheiros, permissões, threads e utilitários adicionais.
...
* redirecionamento de entrada, saída e erro;
* pipes simples e múltiplos;
* cópia de ficheiros;
* cópia de ficheiros com threads;
* histórico das cópias realizadas;
* operações sobre permissões;
* listagem de diretórios;
* calculadora normal;
* calculadora de bits;
* cálculo do epsilon da máquina;
...
Contém os comandos embutidos da shell:
...
Divide a linha escrita pelo utilizador em argumentos.
...
* avisos com atraso;
* avisos em threads;
* cópia de ficheiros em threads;
* histórico das cópias;
* proteção com mutex.

### `shell.ml`

Decide se a linha introduzida corresponde a:
...
Contém o ciclo principal da shell.

### `pipe_sim.ml`

Programa independente que demonstra um pipe simples.
